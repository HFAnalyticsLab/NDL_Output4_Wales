...
# Networked Data Lab: NDL Wales satellite project on Clinically Extremely Vulnerable (CEV) people
...
- This is the repository for the NDL Wales satellite analysis.  
...
This project is licensed under the [MIT License](https://github.com/HFAnalyticsLab/NDL_Output4_Wales/blob/main/LICENSE).
